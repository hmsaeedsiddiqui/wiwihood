...
async function createGiftCardTables() {
  ...
  try {
    console.log('🔄 Creating enhanced gift cards database schema...');
    
    // Drop existing tables to avoid conflicts
    await client.query('DROP TABLE IF EXISTS gift_card_usage CASCADE;');
    
    // Create or update gift_cards table
    await client.query(`
    ...
    const triggers = [
      ...
      'DROP TRIGGER IF EXISTS update_gift_card_transactions_updated_at ON gift_card_transactions;',
      ...
      'DROP TRIGGER IF EXISTS update_gift_card_promotions_updated_at ON gift_card_promotions;',
