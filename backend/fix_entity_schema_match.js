...
async function fixExceptionTableSchema() {
  try {
    console.log('Fixing recurring_booking_exceptions table schema to match entity...');
    
    // Drop and recreate with exact entity mapping
    await pool.query('DROP TABLE IF EXISTS "recurring_booking_exceptions" CASCADE;');
    console.log('✅ Dropped old table');
    
    // Create table with exact schema matching the entity
    ...
    console.log('✅ Created table with correct schema matching entity');
