...
export class Provider {
  ...
  @ApiProperty({ description: 'Preferred payout method' })
  @Column({ name: 'payout_method', type: 'varchar', length: 50, default: 'bank_transfer' })
  payoutMethod: string;

  @ApiProperty({ description: 'Bank account details for payouts' })
  ...
  @OneToMany(() => Staff, (staff) => staff.provider)
  staff: Staff[];
