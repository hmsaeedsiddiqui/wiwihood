      ...
      <div className="flex items-center space-x-4 relative z-10">
        ...
        <div className="relative" ref={menuRef}>
          ...
          {isMenuOpen && (
            <>
              {/* Backdrop overlay */}
              <div className="fixed inset-0 z-[10001] bg-transparent bg-opacity-10" onClick={() => setIsMenuOpen(false)} />
              
              {/* Dropdown */}
              <div className="absolute right-0 top-full mt-2 w-56 bg-white rounded-xl shadow-2xl border border-gray-100 py-3 z-[10002]"
                   style={{
