    ...
    <div className="min-h-screen bg-gray-50">
      <div className="">
        ...
        <div className="mb-6 sm:mb-8">
          <h1 className="text-xl sm:text-3xl font-bold text-gray-900 mb-1 sm:mb-2">My Reviews</h1>
          <p className="text-gray-600 text-xs sm:text-base px-1 sm:px-0">View and manage customer reviews for your services</p>
        </div>
