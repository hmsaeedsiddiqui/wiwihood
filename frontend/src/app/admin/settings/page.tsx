...
export default function AdminSettings() {
  ...
  const [settings, setSettings] = useState({
    ...
    contactEmail: 'support@reservista.com',
    ...
    smtpPort: '587',
    smtpUsername: 'noreply@reservista.com',
    smtpPassword: '********',
    emailFromName: 'Reservista',
    emailFromAddress: 'noreply@reservista.com',
  ...
  const SettingCard = ({ title, description, children, warning = false }) => (
    <div className={`bg-white rounded-lg shadow-sm border p-6 ${warning ? 'border-orange-200' : 'border-gray-200'}`}>
      <div className="mb-4">
        ...
        <div className="flex items-center space-x-4">
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-500 mt-1">
              Current rate: {settings.platformCommission}% per booking
            </p>
          </div>
        </div>
      </SettingCard>
